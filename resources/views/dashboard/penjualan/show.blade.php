                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>Produk</th>
                            <th class="text-center" style="width:8%;">Sak</th>
                            <th class="text-end hide-mobile" style="width:12%;">Berat Kirim</th>
                            <th class="text-center hide-mobile" style="width:10%;">Potongan</th>
                            <th class="text-end" style="width:12%;">Berat Nett</th>
                            <th class="text-end hide-mobile" style="width:12%;">Harga/Kg</th>
